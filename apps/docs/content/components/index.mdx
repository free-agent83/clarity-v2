...
Building with a coding agent? Start from **`COMPONENTS.md`** in the repo (library map), then open individual specs from here — see [Working with AI agents](/docs/get-started/working-with-ai-agents).
