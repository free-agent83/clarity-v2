...
Publish the Clarity design system as a public-facing site at `clarity.nivoda.com`, with the component library running as a publicly accessible Storybook at `storybook.clarity.nivoda.com`. Single unified surface covering foundations, brand, content, components, and patterns. Gaps ship visible with placeholder copy rather than hidden.
