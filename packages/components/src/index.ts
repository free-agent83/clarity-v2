...
export type { MegamenuProps, MegamenuGroupProps, MegamenuTriggerProps, MegamenuContentProps, MegamenuLinkProps, MegamenuTabsProps } from "./components/organisms/megamenu/megamenu";
